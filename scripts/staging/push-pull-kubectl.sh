...
# Usage:
#   Push: ./kubectl-ghcr-oci.sh push --tag <tag> --namespace <ghcr-path> --username <user> --password <token>
#   Pull: ./kubectl-ghcr-oci.sh pull --tag <tag> --namespace <ghcr-path> --username <user> --password <token>
